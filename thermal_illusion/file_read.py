...
img_path = 'C:/Users/Hayato/Documents/GitHub/personal/thermal_illusion/20201007experiment/'
...
plt.imshow(img_trans, cmap=cm.hot,vmin=28,vmax=38) 
pp = plt.colorbar(orientation= "vertical")
pp.mappable.set_clim(10,50)
plt.axis([0,79,0,59])
plt.show()